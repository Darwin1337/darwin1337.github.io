...
with open(r"C:\Users\diogo\Desktop\Lista Candidatos.json", encoding = "utf8") as json_file1:
    candidatos = json.load(json_file1)
with open(r"C:\Users\diogo\Desktop\Lista Colocados.json", encoding = "utf8") as json_file2:
