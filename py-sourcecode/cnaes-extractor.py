...
DriverPath = r"C:\Users\diogo\Desktop\MrPiracy Automator\chromedriver.exe"
driver = webdriver.Chrome(DriverPath)

link = ["https://www.dges.gov.pt/coloc/2020/col1listas.asp?CodR=11&action=2", "https://www.dges.gov.pt/coloc/2020/col1listas.asp?CodR=12&action=2"]
...
try:
    for p in range(2):
        ...
        for x in range(len(driver.find_elements_by_class_name("inputtext > option"))):
            if "Universidade do Algarve - Instituto Superior de Engenharia" in str(driver.find_elements_by_class_name("inputtext > option")[x].get_attribute('innerHTML')[7:]):
                JSONindex = 0
                JSONcontent = ""
                ...
                for j in range(len(driver.find_elements_by_class_name("inputtext > option"))):
                    if "Engenharia Alimentar" in str(driver.find_elements_by_class_name("inputtext > option")[j].get_attribute('innerHTML')[7:].replace("\n", "")):
...
#                     URLGerado = "https://www.dges.gov.pt/coloc/2020/col1listaser.asp?CodEstab=" + str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[2]/tbody/tr/td/a").get_attribute("href").split("=")[1].split("&")[0]) + "&CodCurso=" + str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[2]/tbody/tr/td/a").get_attribute("href").split("=")[2].split("&")[0]) + "&ids=1&ide=" + str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[2]/tbody/tr/td/a").get_attribute("href").split("=")[5]) + "&Mx=" + str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[2]/tbody/tr/td/a").get_attribute("href").split("=")[5])
...
#                     JSONcontent['data'][int(JSONindex)]['candidatos'].append({ "nome": str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[4]/tbody/tr[%s]" % (c + 1)).find_elements_by_tag_name('td')[2].get_attribute('innerHTML').replace("/n", "").strip()), "nota": str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[4]/tbody/tr[%s]" % (c + 1)).find_elements_by_tag_name('td')[3].get_attribute('innerHTML').replace("/n", "").strip()), "opcao": opcao, "prova_ingresso": str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[4]/tbody/tr[%s]" % (c + 1)).find_elements_by_tag_name('td')[5].get_attribute('innerHTML').replace("/n", "").strip()), "nota_12ano": str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[4]/tbody/tr[%s]" % (c + 1)).find_elements_by_tag_name('td')[6].get_attribute('innerHTML').replace("/n", "").strip()), "nota_10ano_11ano": str(driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/table[4]/tbody/tr[%s]" % (c + 1)).find_elements_by_tag_name('td')[7].get_attribute('innerHTML').replace("/n", "").strip()) })
...
#                 driver.find_element_by_xpath("/html/body/div/table/tbody/tr/td/div[2]/a").click()
#                 print("Candidatos guardados: " + str(TotalCandidatos) + " de 62561\n")
#                 JSONindex = JSONindex + 1
#             JSONarray.append(JSONcontent)
#             driver.get(link[p])
#     print("A guardar ficheiro com a informação...")
